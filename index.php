...
<body>
   ...
   <div class="main container">
        ...
        <!-- end of navbar -->
        <div class="cities sub container hidden" id="countries_select_section">
            ...
            <div class="all_countries flex">
                ...
                <div class="countries flex">
                    <div class="countries_label">
                        <a href="china/ch_index.php">CHINA</a>
                    </div>
                </div>
            </div>
           
        </div>
        <div class="cities sub container hidden" id="about_us_section">
            <div class="about_us">
                <div class="title">About US</div>
                <div class="profile" id="even">
                    <div class="photo">
                       <img src="https://kimmyyo.github.io/IMG_5366.jpg">
                    </div>
                    <div class="info">
                        <div class=name>Kimmy, Yo</div>
                        <p class="paragraph">Hey, it's Kimmy. Happy to work on web programming. And glad to have this chance to work with our team members. Hope u guys enjoy our website!</p>
                    </div>
                   
                </div>
                <div class="profile" id="odd" >
                    
                    <div class="info">
                        <div class=name>Dan, Wang</div>
                        <p class="paragraph">
                            I'm Dan, from Hsinchu, Taiwan.
                            My hobbies are playing tennis and Lego.
                            I'm responsible for the page of UK.
                            Hope you enjoy~
                        </p>
                    </div>
                    <div class="photo">
                        <img src="images/dan_profile.jpg">
                    </div>
                ...
                <div class="profile" id="even" >
                    <div class="photo">
                        <img src="images/Liu_profile.jpg">
                    </div>
                    <div class="info">
                        <div class=name>Chien-Yu, Liu</div>
                        <p class="paragraph">
                            I'm Liu, Chien-Yu, come from Taiwan Taipei.
                            My hobbies are playing basketball and the piano.
                            The page I responsible for is China.
                            I choose some places hightly recommend you to go!
                            Hope you like it.</p>
                    </div>
                </div>
                <div class="profile" id="odd">
                    ...
                    <div class="info">
                        <div class=name>Guan-Ru, Lin</div>
                        <p class="paragraph">
                            Hi, this is Guan-Ru and I like travelling a lot. 
                            Of all places I’ve been to, the US is the one I found most interesting, and therefore would like to share. 
                            Also, some travel tips were provided base on my past experiences. 
                            Hope you enjoy our website and get inspired.
                        </p>
                    </div>
                    <div class="photo">
                        <img src="images/guanru_profile.jpg">
                    </div>
                </div>
            </div>
        </div>

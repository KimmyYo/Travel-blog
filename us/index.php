...
<body>
   ...
   <div class="main container">
        <!-- start of navbar  -->
        <div class="home sub container background" id="us_banner">
            ...
            <div class="home  title">United States of America</div>
        </div> 
        <!-- end of navbar -->
        ...
        <div class="cities sub container hidden">   
            <div class="quote">    
                <div class="title">
                    <a href="" class="typewrite" data-period="2000" data-type='[ "Welcome to America." ]'>
                ...
                <div class="shortIntro"><p>"Got my hands up, they're playing my song</p></div>
                <div class="shortIntro"><p>I know I'm gonna be okay</p></div>
                <div class="shortIntro"><p>Yeah, it's a party in the U.S.A"</p></div>
                <div class="shortIntro"><p>-- Miley Cyrus, Party in the USA</p></div>
            </div>    
        </div>
        ...
        <div class="cities sub container hidden">
            <div class="allBoxes">
                ...
                <div class="box">
                    <a href="newyork.php" class="link">
                        <div class="photo"><img src="images/newyorkskyscrapers.jpg"></div>
                        <div class="name"><span>#New York</span></div> 
                    </a>
                </div>

                <div class="box">
                    <a href="washington.php" class="link">
                        <div class="photo"><img src="images/washingtondc.jpg"></div>
                        <div class="name"><span>#Washington DC</span></div>
                    </a>
                </div>

                <div class="box">
                    <a href="philadelphia.php" class="link">
                        <div class="photo"><img src="images/philly.jpg"></div>
                        <div class="name"><span>#Philadelphia</span></div>
                    </a>
                </div>

...
<body>
    <div class="main container">
        <!-- start of navbar -->
        <div class="home sub container" id="sabah_banner">
            ...
            <div class="home title">Sabah</div>
        </div>
        ...
        <div class="the_article">
            <article>
                <div class="title hidden">The beautiful island at the east side of Malaysia.</div>
                <div class="content">
                    <div class="quote hidden">A great amount of small island around.</div>
                    <div class="quote hidden">Beautiful ocean.</div>
                    <div class="quote hidden">Food with different taste from main island.</div>
                </div>

                <div class="content hidden">
                    <div class="sub_title">Mosque and mosque</div>
                    <p class="paragraph">
                        There are many mosques in Sabah with different but amazing style.
                        When I was visiting these mosques, I learned Islam culture at the same time. 
                        What time do they perform the ritual? How do they perform the ritual? The bell rings at the ceratin time sounded so different, and the hijab they wear also vary from different person.
                    </p>
                    <ul class="image flex">
                        <li>
                            <img src="images/IMAG3385.jpg">
                        </li>
                        <li>
                            <img src="images/IMAG3435.jpg">
                        </li>
                    </ul>   
                </div>
                <div class="content hidden">
                    <div class="sub_title">Riding scooter</div>
                    <p class="paragraph">
                        It's easy to ride the bike to different sightseeing spots in Sabah. Me and my friend rent a scooter for 3 days. At the time I don't have a scooter license, so I was the one who direct the driver. 
                        However, it's some how not easy to understand how was the pattern of the road, so it's kind of mess when we try to go to somewhere. But still, it's a convenient way to travel in Sabah.
                    </p>
                    <ul class="image flex">
                        <li>
                            <img src="images/IMAG3463.jpg">
                        </li>
                        <li>
                            <img src="images/2019-06-29-20-20-39.jpg">
                        </li>
                    </ul>   
                    </div>
                <div class="content hidden">
                    <div class="sub_title">Mengalum Island</div>
                    <p class="paragraph">
                        There are so many island around Sabah, we chose Mengalum Island to travel.
                        We took a boat from main island to there, to go snorkeling.
                        It was my first time trying snorkeling, and it was also my first time seeing how beautiful the marine creatures are. 
                        Corals, clown fish, every creature I expected to find in the ocean all showed in my front. 
                        There's also lifeguard beside us, so glad that he took many fantastic pictures for us. 
                        Funny thing was that at the time we had to go back to the beach, I just couldn't approach to our ship, 'cause the wave push me away from our ship. 
                        Hopefully the lifeguard brought us back.

                        The beach in Mengalum Island was also amazing, clear ocean water, white and shiny sand, swing lying on the beach. Fely like the world most beautiful scenenary was right in frout of me.
                    </p>
                    <ul class="image flex">
                        <li>
                            <img src="images/2019-06-30-09-27-28.jpg">
                        </li>
                        <li>
                            <img src="images/2019-06-30-09-25-01.jpg">
                        </li>

...
<body>
   ...
   <div class="main container">
        <!-- start of navbar -->
        <div class="home sub container" id="malaysia_banner">
        ...
        <div class="cities sub container hidden" >
            <div class="quote">
                ...
                <div class="shortIntro hidden"><p>A place that could occur you the Chinese history.</p></div>
                <div class="shortIntro hidden"><p>An cultural fusion island.</p></div>
                <div class="shortIntro hidden"><p>The impact of colonization.</p></div>
            </div>
        </div>
        <div class="cities sub container hidden" id="polarid_section" >
            <div class="allBoxes">
                <div class="box">
                    <a href="penang.php" class="link">
                        <div class="photo">

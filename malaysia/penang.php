...
<body>
    <div class="main container">
        <!-- start of navbar -->
        <div class="home sub container" id="penang_banner">
                        ...
                        <div class="item">
                            ...
                            <div class="sub_item_section" id="secondary_sub_sub_menu">
                                <ul class="sub_choices" >
                                    ...
                                    <li class="country_name"><a href="index.php">Malaysia</a></li>
            ...
            <div class="home title">Penang</div>
    
        </div>
        <!-- end of navbar -->
        <div class="the_article">
            <article>
                <div class="title hidden">How does penang looks like?</div>
                <div class="content">
                    <div class="quote hidden">A state with Chinese, Malaysian, and Indian culture.</div>
                    <div class="quote hidden">A place full of delicious food.</div>
                    <div class="quote hidden">Beautiful street and building while you're sightseeing.</div>
                </div>

                <div class="content hidden">
                    <div class="sub_title">Food and Chinese culture</div>
                    <p class="paragraph">
                        The best impression of Penang is the food and chinese culture in Penang. Cantonese-style noodles, dessert, Burburchacha..., every food I'd tried is beyond my expectation, with surprise, amaze, and delight.
                    </p>
                    <ul class="image flex">
                        <li>
                            <img src="images/2019-07-03-11-05-04.jpg">
                        </li>
                        <!-- <li>
                            <img src="images/20190702_171245.jpg">
                        </li> -->
                        <li>
                            <img src="images/20190703_095500.jpg">
                        </li>
                    </ul>   
                </div>
                <div class="content hidden">
                    <p class="paragraph">
                        Recalling the history textbook that Chinese culture had spread to south-east Asia. I saw so much building, temple and even the language they use are like different dialect of Taiwanese.
                        If you got a chance to walk through every alley in Penang, you will be amazed by how beautiful those traditional building look like. 
                    </p>
                    <ul class="image flex">
                        <li>
                            <img src="images/2019-07-03-13-57-39.jpg">
                        </li>
                        <li>
                            <img src="images/2019-07-03-15-59-50.jpg">
                        </li>
                        <!-- <li>
                            <img src="images/2019-07-03-19-10-26.jpg">
                        </li> -->
                    </ul>
                </div>
                <div class="content hidden">
                    <div class="sub_title">Culture Fusion</div>
                    <p class="paragraph">
                        Penang is also a place with a various of culture, especially Indian, Malaysian, and Chinese culture. Without taking a long filght to different countries, one can experience these culture in a small state.
                        One thing that I remembered the most is while I was taking the taxi, different taxi drivers with different races played the radio that belongs to their language. Although it might be something small, it is something that you can't easily experience.
                        There's also a place call "Small India", as the name of the area shown, it's a region with a great amout of India culture. Not only their food, but also India traditional clothing, Hindu temple. 
                        As I stepped into the area, I felt like I was standing in India. Moreover, "Small India" is not like a absolute region with boundaries, it even let Mosque, temples, Hindu temple lied in the same place. 
                    </p>
                    <ul class="image flex">
                        <li>
                            <img src="images/2019-07-02-17-03-41.jpg">
                        </li>
                        <li>
                            <img src="images/20190702_170858.jpg">
                        </li>
                    </ul>
                </div>
                <div class="content hidden">
                    <div class="sub_title">Georgetown - UNESCO Historic Site</div>
                    <p class="paragraph">
                        Another attracting area I'd visited is "Georgetown", it's an area with soooooo much amazing street art. 
                        I even got a map to go around every small alley in the town to find those street art.
                    </p>
                    <ul class="image flex">
                        <li>
                            <img src="images/2019-07-04-11-02-56.jpg">
                        </li>
                        <li>
                            <img src="images/2019-07-04-17-52-10.jpg">
                        </li>
                        <li>
                            <img src="images/2019-07-04-11-44-47.jpg">
                        </li>
                        <li>
                            <img src="images/2019-07-04-13-57-40.jpg">
                        </li>
                        <!-- <li>
                            <img src="images/2019-07-04-16-15-51.jpg">
                        </li> -->
                        <li>
                            <img src="images/2019-07-04-16-44-18.jpg">
                        </li>
                    </ul>
                    <p class="paragraph">
                        The trip in Georgetown was like an adventure to find treasure, and always got amazed by another small beautiful things beside. 
                    </p>
                </div>
            </article>
        </div>

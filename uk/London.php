...
<body>
    <div class="main container">
        <div class="home sub container" id="london_banner">
            ...
            <div class="home title">London</div>      
        </div>
        
<!--  -->
        <div class="the_article">
            <article>
                <div class="title">The capital of UK</div>
                <div class="content">
                    <div class="quote">The Mod</div>
                    <div class="quote">Divided by the River Thames</div>
                    <div class="quote">Culture diversity, entertainment and economic center...</div>
                </div>
                ...
                <div class="content">
                    ...
                    <ul class="image flex">
                        <li>
                            <img src="images/london/207.jpg">
                        </li>
                        <li>
                            <img src="images/london/201.jpeg">
                        </li>
                    </ul>   
                    
                </div>
                <div class="content">
                    <div class="sub_title">Take a glimpse</div>
                    <p class="paragraph">
                        No visit to London is complete without having a look of Buckingham Palace, Big Ben, London Bridge...
                        My first recommandation is watching The King’s Guard changing ceremony in front of Buckingham Palace.
                        If you are lucky enough, you can take a picture with horses.
                    </p>
                    <ul class="image flex">
                        <li>
                            <img src="images/london/204.jpg">
                        </li>
                        <li>
                            <img src="images/london/206.jpg">
                        </li>
                    </ul>
                </div>    
                <div class="content">
                    <div class="sub_title">Time to relax</div>
                    <p class="paragraph">
                        Like New York Time Square, London also has a place with many LED billboard - Piccadilly Circus.
                        Nearby are Oxford Circus and Regent St where you are able to find some global brand flagship stores.
                    </p>
                    <ul class="image flex">
                        <li>
                            <img src="images/london/202.jpeg">
                        </li>
                        <li>
                            <img src="images/london/209.jpg">
                        </li>
                    </ul>

...
<head>
    ...
    <meta property="og:url" content="https://kimmyyo.github.io/Travel-blog/index.html">
...
<body>
    <div class="main container">
        <div class="home sub container background" id="york_banner">
...
<!--  -->
        ...
        <article>
            <div class="title">The most haunted city of United Kingdom </div>
            <div class="content">
                <div class="quote">Surrounded inside the York City Wall </div>
                <div class="quote"></div>
                <div class="quote">Ghost stories, ancient church, slow–moving lifestyle...</div>
            </div>
            ...
            <div class="content">
                ...
                <ul class="image flex">
                    <li>
                        <img src="images/york/307.jpg">
                    </li>
                    <li>
                        <img src="images/york/310.jpg">
                    </li>
                </ul>   
            </div>
            <div class="content">
                <div class="sub_title">York Ghost Merchants</div>
                <p class="paragraph">
                    Being "The most haunted city in UK", York has a vary famous shop that selling unique ghost figures.
                    Inside the shop, there are houndreds of second to none, handmade figures. 
                    Each has a multi-color painting, just come inside and find your favorite one.
                </p>
                <ul class="image flex">
                    <li>
                        <img src="images/york/305.jpeg">
                    </li>
                    <li>
                        <img src="images/york/306.jpg">
                    </li>
                </ul>     
            </div>
            
            <div class="content">
                <div class="sub_title">Slow–moving life</div>
                <p class="paragraph">
                Though most York's famous spots are in the town, there are a church that needs to take a 20-minute train.
                Selby Abbey is a famed church for Taiwanese because Jay Chou's wedding was hold in here. The interior of this church is very refined.
                </p>
                <ul class="image flex">
                    <li>
                        <img src="images/york/302.jpeg">
                    </li>
                    <li>
                        <img src="images/york/301.jpeg">
                    </li>
                </ul>
                <p class="paragraph">
                Speaking to "British Style", you can never miss the "British afternoon tea".
                Bettys is the most well-known café tea store in York. People always line up waiting to have a try on their food.
                Scones with butter, sandwiches and desserts are all placed on a three-tier tea stand. Almost every table order that set. 
                </p>
                <ul class="image flex">
                    <li>
                        <img src="images/york/303.jpeg">
                    </li>
                    <li>
                        <img src="images/york/304.jpeg">
                    </li>
                </ul>     

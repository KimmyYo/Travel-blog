...
<body>
    <div class="main container">  
      <div class="home sub container background" id="edinburgh_banner">
            ...
            <div class="home title">Edinburgh</div>
        </div>
...
<!--  -->
        <div class="the_article">
            <article>
                <div class="title">The Towns of Edinburgh </div>
                <div class="content">
                    <div class="quote">The capital of Scotland </div>
                    <div class="quote">Old town & New town</div>
                    <div class="quote">Whisky, Castles, Giraffas... </div>
                </div>
                ...
                <div class="content">
                    ...
                    <ul class="image flex">
                        <li>
                            <img src="images/edinburgh/106.jpg">
                        </li>
                        <li>
                            <img src="images/edinburgh/107.jpg">
                        </li>
                    </ul>   
                    
                </div>
                <div class="content">
                    <div class="sub_title">Elegant Architectures</div>
                    <p class="paragraph">
                        In one of Jay Chou's MV "明明就", there are lots of scenes fliming in Edinburgh.
                        Climing up Calton Hill, you can see some famous architecture of Edinburgh, National Monument of Scotland, Edinburgh, Nalson Monument and Royal Observatory.
                        When you walk to the cliff, you will see the beauty of both old and new town of Edinburgh.
                    </p>
                    <ul class="image flex">
                        <li>
                            <img src="images/edinburgh/103.jpg">
                        </li>
                        <li>
                            <img src="images/edinburgh/102.jpg">
                        </li>
                    </ul>     
                </div>
                <div class="content">
                    <div class="sub_title">Worth give it a try</div>
                    <p class="paragraph">
                        Walking in the city, you can always find colorful-painted installation giraffas, 
                        there are more than 40 giraffas around the city, and each has different fascinating details, just collect them all!
                    </p>
                    <ul class="image flex">
                        <li>
                            <img src="images/edinburgh/108.jpg">
                        </li>
                        <li>
                            <img src="images/edinburgh/109.jpg">
                        </li>
                    </ul>
                    <p class="paragraph">
                        Besides giraffas, there are also some street artists performing "Great Highland Bagpipe". Have a listen.
                        Last but not least, the delicious Artisan Gelato's ice cream is a must try!
                    </p>
                    <ul class="image flex">
                        <li>
                            <img src="images/edinburgh/111.jpg">
                        </li>
                        <li>
                            <img src="images/edinburgh/110.jpg">
                        </li>
                    </ul>     

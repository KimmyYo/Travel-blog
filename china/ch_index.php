...
<body>
    <div class="main container">
                <!-- start of navbar  -->
        <div class="home sub container background" id="china_banner">
            ...
            <div class="home title">China</div>
        </div>
        ...
        <div class="cities sub container">
            <div class="quote">
                <div class="title">
                    <a href="" class="typewrite" data-period="2000" data-type='[ "What is Your imagination of China?" ]'>
                ...
                <div>
                    <p class = "shortIntro hidden">A place with a deep cultural heritage</p>
                    <p class = "shortIntro hidden">Lots of spectacular views</p>
                    <p class = "shortIntro hidden">A big market in the world</p>
                </div>
        </div>
        <div class="cities sub container hidden" id="polarid">
            <div class="allBoxes">
                <div class="box">
                    <a href="北京.php" class="link">
                        <div class="photo">
                            <img src="images/北京封面.jpg">
                        </div>
                        <div class="name"><span>#Beijing</span></div> 
                    </a>
                </div>
                <div class="box">
                
                    <a href="甘肅.php" class="link">
                        <div class="photo">
                            <img src="images/甘肅封面.jpg">
                        </div>
                        <div class="name"><span>#Gansu</span></div>
                    </a>
                </div>
                <div class="box">
                    <a href="上海.php" class="link">
                        <div class="photo">
                            <img src="images/上海封面.jpg">
                        </div>
                        <div class="name"><span>#Shanghai</span></div>
                    </a>
                </div>
            </div>
        </div>

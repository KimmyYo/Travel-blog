...
<body>
    <div class="main container">
        <!-- start of navbar  -->
        <div class="home sub container background" id="Shanghai_banner">
                        ...
                        <div class="item">
                            ...
                            <div class="sub_item_section" id="secondary_sub_sub_menu">
                                <ul class="sub_choices" >
                                    ...
                                    <li class="country_name"><a href="ch_index.php">China</a></li>
                                </ul>
            ...
            <div class="home title">Shanghai</div>
        </div>
...
<div class="the_article">
    <article>
        <div class="title hidden">A global city for finance, innovation, commerce, and trade.</div>
        <div class="content hidden">
            <div class="quote hidden">A morden city.</div>
            <div class="quote hidden">Colorful nightlife.</div>
            <div class="quote hidden">Qick tempo city.</div>
        </div>


        <div class="content hidden">
            <div class="sub_title">Wukang Road</div>
            <p class="paragraph">
                Everyone’s impression of Shanghai might be prosperous city and hubbub urban block. 
                However, here in Wukang Road you can only feel pleased and low tempo environment where are many residences live around there. 
                Moreover, the side walk there is really clean and it's really quite also!
                Sometimes, you may see some exquisite shops and brunch restaurants in the old building. 
                Overall, the hole environment let people feel comfortable and chill.
            </p>
            <ul class="image flex">
                <li>
                    <img src="images/wukang road1.jpg">
                </li>
                <li>
                    <img src="images/wukang road2.jpg">
                </li>
                <li>
                    <img src="images/wukang road3.jpg">
                </li>
                <li>
                    <img src="images/wukang road5.jpg">
                </li>
            </ul>   
        </div>

        <div class="content hidden">
            <div class="sub_title">Brunch</div>
            <p class="paragraph">
                In Wukang Road there is a nice brunch restaurant I recommend you.
                It’s called LOKAL. 
                The payment there is not that cheep but the quantity and quality are perfect!
                If you have a chance to go there, I strongly recommend you to have a great meal there!
            </p>
            ...
            <ul class="image flex">
                ...
                <li>
                    <img src="images/brunch2.jpg">
                </li>
                <li>
                    <img src="images/brunch3.jpg">
                </li>
            </ul>   
        </div>

        <div class="content hidden">
            <div class="sub_title">Thames Town</div>
            <p class="paragraph">
                An exotic place with many England architectures. 
                There is a famous library there, it included many kinds of books. 
                And the feature of the library is its directory, everywhere is full of books. 
            </p>
            <ul class="image flex">
                <li>
                    <img src="images/Thames Town1.jpg">
                </li>
                <li>
                    <img src="images/Thames Town2.jpg">
                </li>
                <li>
                    <img src="images/Thames Town3.jpg">
                </li>
                <li>
                    <img src="images/Thames Town4.jpg">
                </li>
        ...
        <div class="content hidden">
            <div class="sub_title">Guangfulin Cultural Site Park</div> 
            <p class="paragraph">
                A place with different kind of countries’ buildings and the ancient civilization which initially confirmed in scientific archaeology. 
                It’s hard to think that in a busy city having an ancient civilization. 
                In addition, there are many museums which combine modern audio-visual technology to design the archaelolgical memory of Guangfulin.
            </p>

            <ul class="image flex">
                <li>
                    <img src="images/Guangfulin1.jpg">
                </li>
                <li>
                    <img src="images/Guangfulin2.jpg">
                </li>
                <li>
                    <img src="images/Guangfulin3.jpg">
                </li>
                <li>
                    <img src="images/Guangfulin4.jpg">
                </li>
                <li>
                    <img src="images/Guangfulin5.jpg">
                </li>
            </ul>  
        </div>

        <div class="content hidden">
            <div class="sub_title">Starbucks Reserve</div>
            <p class="paragraph">
                There are only 6 Starbucks Reserve in the world. 
                And Shanghai has one which including wine, tea, coffee and the first stop for coffee beans at the Roastery. 
                The most attracting thing is that it’s really beautiful!
            </p>
            <ul class="image flex">
                <li>
                    <img src="images/Starbucks1.jpg">
                </li>
                <li>
                    <img src="images/Starbucks2.jpg">
                </li>
                <li>
                    <img src="images/Starbucks4.jpg">
                </li>
                <li>
                    <img src="images/Starbucks5.jpg">
                </li>
                <li>
                    <img src="images/Starbucks6.jpg">
                </li>
            </ul>          
        </div>

        <div class="content hidden">
            <div class="sub_title">Duoyun Books</div>
            <p class="paragraph">
                The world highest library, Duoyun Books, has a wonderful view to see part of Shanghai. 
                Moreover, the building there is one of the most important offices in Shanghai.
            </p>
            <ul class="image flex">
                <li>
                    <img src="images/Duoyun1.jpg">
                </li>
                <li>
                    <img src="images/Duoyun3.jpg">
                </li>
                <li>
                    <img src="images/Duoyun4.jpg">
                </li>
                <li>
                    <img src="images/Duoyun5.jpg">
                </li>
            </ul>          
        </div>

        <div class="content hidden">
            <div class="sub_title">Night in Shanghai</div>
            <p class="paragraph">
                It still has a lively life in the night at Shanghai. 
                Shopping, staying at the bar, enjoying the scenery and so on. 
                Just come and see!
            </p>
            <ul class="image flex">
                <li>
                    <img src="images/night1.jpg">
                </li>
                <li>
                    <img src="images/night2.jpg">
                </li>
                <li>
                    <img src="images/night3.jpg">
                </li>
                <li>
                    <img src="images/night4.jpg">
                </li>
                <li>
                    <img src="images/night5.jpg">
                </li>
            </ul>          
        </div>
    </article>
            ...
            <div class="horizon_part">
                ...
                <div class="flex">
                    <ul>
                        ...
                        <li><a href="ch_index.php">China</a></li>
                    </ul>
                </div>
                <div class="flex">
                    <ul>

...
<body>
    <div class="main container">
        <!-- start of navbar  -->
        <div class="home sub container background" id="Gansu_banner">
            ...
            <div class="home title">Gansu</div>
        </div>
    ...
    <div class="the_article">
        <article>
            <div class="title hidden">A place full of magnificent views and minority culture.</div>
            <div class="content hidden">
                <div class="quote hidden">Different terrain.</div>
                <div class="quote hidden">Impressive shock with the wise accient culture.</div>
                <div class="quote hidden">night becomes dark at 9 pm.</div>
            </div>
    
            <div class="content hidden">
                <div class="sub_title">Jiayu Pass</div>
                <p class="paragraph">
                    A majestic scene that I saw. It’s a stronghold in the ancient day when people went on “Silk Way”. 
                    Therefor we can saw a big wall which protected the people staying inside and some entertainment stages and so on. 
                    Moreover, the view outside the castle is quite impressive!
                </p>
                <ul class="image flex">
                    <li>
                        <img src="images/Jiayu Pass1.jpg">
                    </li>
                    <li>
                        <img src="images/Jiayu Pass2.jpg">
                    </li>
                    <li>
                        <img src="images/Jiayu Pass3.jpg">
                    </li>
                    <li>
                        <img src="images/Jiayu Pass4.jpg">
                    </li>
                    <li>
                        <img src="images/Jiayu Pass5.jpg">
                    </li>
                </ul>   
            </div>

            <div class="content hidden">
                <div class="sub_title">Danxia Zhangye National Geological Park</div>
                <p class="paragraph">
                    Incredible views that I saw! It’s the first time I realize that world has this kind of terrain. 
                    And the wind there is really big that everything on us gonna fly away.
                </p>
                <ul class="image flex">
                    <li>
                        <img src="images/Zhangye1.jpg">
                    </li>
                    <li>
                        <img src="images/Zhangye2.jpg">
                    </li>
                    <li>
                        <img src="images/Zhangye3.jpg">
                    </li>
                    <li>
                        <img src="images/Zhangye4.jpg">
                    </li>
                    <li>
                        <img src="images/Zhangye5.jpg">
                    </li>
                </ul>   
            </div>

            <div class="content hidden">
                <div class="sub_title">Mogao Grottoes</div>
                <p class="paragraph">
                    It’s hard to think that many years ago the ancient people have the technic to build those magnificent sculpture. 
                    When I saw those drawing and sculpture, I just realized that there are too many thing outside the world looking forward to being found out by us! 
                </p>
                <ul class="image flex">
                    <li>
                        <img src="images/Mogao Grottoes1.jpg">
                    </li>
                    <li>
                        <img src="images/Mogao Grottoes2.jpg">
                    </li>
                    <li>
                        <img src="images/Mogao Grottoes3.jpg">
                    </li>
            ...
            <div class="content hidden">
                <div class="sub_title">Dunhuang Desert</div>
                <p class="paragraph">
                    The place I want to go to the most at that trip in Gansu. 
                    Desert, a boundless place where people get in would feel helpless. 
                    And that’s the truth of the natural strength. The only little disappointment is that there were to many tourists out there, and the camels were meagre cause they walk too much and some of them even yelling loudly to the people. 
                    I felt pitiful to them.
                </p>
                <ul class="image flex">
                    <li>
                    ...
                    <li>
                        <img src="images/Desert4.jpg">
                    </li>
                    <li>
                        <img src="images/Desert5.jpg">
                    </li>
            ...
            <div class="content hidden">
                <div class="sub_title">Lanzhou city and views</div>
                <p class="paragraph">
                    Though Gansu is a very inner-land province, the city there is still prosperity. 
                    Moreover, they also have MRT there!!! 
                    And the views we pass by when went to the other places were really pretty!

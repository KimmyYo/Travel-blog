...
<body>
    <div class="main container">
        <!-- start of navbar  -->
        <div class="home sub container background" id="Beijing_banner">
            ...
            <div class="home title">Beijing</div>
        </div>                        
        <!-- end of navbar -->
    ...
    <div class="the_article">
        <article>
            <div class="title hidden">A place with deep cultural heritage.</div>
            <div class="content hidden">
                <div class="quote hidden">Beautiful architecture.</div>
                <div class="quote hidden">Full of history.</div>
            </div>
    
            <div class="content hiddenv">
                <div class="sub_title">Palace Museum</div>
                <p class="paragraph">
                    I have been to Taiwan National Palace Museum, so I thought China’s one is just like that. 
                    However, it’s totally different! 
                    It’s so huge and the view is incredible! The structure there is hard to describe by the words but seeing yourself!
                <ul class="image flex">
                    <li>
                        <img src="images/Palace1.JPG">
                    </li>
                    <li>
                        <img src="images/Palace2.jpg">
                    </li>
                    <li>
                        <img src="images/Palace3.jpg">
                    </li>
                    <li>
                        <img src="images/Palace4.JPG">
                    </li>
                </ul>   
            </div>

            <div class="content hidden">
                <div class="sub_title">The Great Wall of China</div>
                <p class="paragraph">
                    Fortunately, the day I went there the snow was not yet melting! 
                    Therefore, we could build a snow man on The Great Wall of China! 
                    In addition, the stair there was very high so it’s hard to take one step to the next step. 
                </p>
                <ul class="image flex">
                    <li>
                        <img src="images/Great Wall1.jpg">
                    </li>
                    <li>
                        <img src="images/Great Wall2.jpg">
                    </li>
                    <li>
                        <img src="images/Great Wall3.jpg">
                    </li>
                    <li>
                        <img src="images/Great Wall4.jpg">
                    </li>
                </ul>   
            </div>

            <div class="content hidden">
                <div class="sub_title">The Temple of Heaven</div>
                <p class="paragraph">
                    The Temple of Heaven displays the unique meanings and symbolic expressions of traditional Chinese culture. 
                    And the building is quite different between the others from Beijing.
                </p>
                <ul class="image flex">
                    <li>
